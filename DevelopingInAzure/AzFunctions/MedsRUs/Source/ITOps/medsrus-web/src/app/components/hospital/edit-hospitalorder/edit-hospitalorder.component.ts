...
@Component({
	selector: 'app-edit-hospitalorder',
	templateUrl: './edit-hospitalorder.component.html',
	styleUrls: ['./edit-hospitalorder.component.css']
})
export class EditHospitalOrderComponent implements OnInit {
